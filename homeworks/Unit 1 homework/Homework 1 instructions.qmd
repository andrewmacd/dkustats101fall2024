...
-   Use the Five W definitions in section 1.2 of the textbook, please describe this dataset.

-   Additionally, using the definitions in textbook section 1.3, please categorize each of the following variables in the `medallists.csv` dataset.
