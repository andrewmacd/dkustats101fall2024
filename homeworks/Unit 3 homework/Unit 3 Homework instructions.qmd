...
-   If we observe that the price of Ravensburger toys in our sample is greater than the population average at $p$=0.06, should we reject the null hypothesis? Why or why not?
...
-   Find the $p$ value for whether the price of Ravensburger toys from the sample is higher than the population average (calculate by hand and show work).
-   What are some possible lurking variables that might make our conclusion unreliable?
