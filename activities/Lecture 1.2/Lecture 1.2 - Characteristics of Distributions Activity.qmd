...
1.	If you have not installed the `ggplot2` package, you can do so by typing `install.packages("ggplot2")` into the Console at the bottom of your RStudio terminal. Answer `yes` when prompted.
