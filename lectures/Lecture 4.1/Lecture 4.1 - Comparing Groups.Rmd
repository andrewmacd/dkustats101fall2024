...
```{r kingcounty, echo=FALSE, out.width="800px", fig.cap="Seattle waterfront"}
knitr::include_graphics("www/seattlewaterfront.jpeg")
```
...
```{r viewpct, fig.height=4, exercise=TRUE}
