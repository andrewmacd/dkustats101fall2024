...
```{r nbateamdescribe, exercise=TRUE}
# Get a list of variable names
names(nbaboxscores)

# Take a quick look at the data - remove the # character in front of glimpse to run this line
...
### Points by away team \> 150 - true outliers?
